%% Speed BBMin Permutations 

clear;
clc;

T91153 = readtable("bb_min_result_91153.txt");
T93019 = readtable("bb_min_result_93019.txt");
T93195 = readtable("bb_min_result_93195.txt");
